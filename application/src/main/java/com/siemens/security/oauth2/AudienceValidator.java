package com.siemens.security.oauth2;
...
public class AudienceValidator implements OAuth2TokenValidator<Jwt>
{
    ...
    private final OAuth2Error error = new OAuth2Error(Constants.INVALID_TOKEN_ERROR_CODE, "The required audience is missing", null);
